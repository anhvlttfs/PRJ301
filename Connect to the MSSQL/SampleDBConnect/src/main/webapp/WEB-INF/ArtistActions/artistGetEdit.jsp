            ...
            <div class="container col-xxl-8 px-4 py-5">
                <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                    <div class="col-lg-12">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="PostEditUser('<%= (String) request.getParameter("id") %>')">Edit</button>
                    </form>
                </div>
            </div>
        </main>
        <script src="<% out.print(request.getContextPath());%>/js/postEdit.js"></script>
